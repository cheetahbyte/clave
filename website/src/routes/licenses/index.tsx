...
function LicensesPage() {
  ...
  const params: ListLicensesParams = { q, status, productId: productId || undefined, page, pageSize };
  ...
  const createDialog = (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent>
            ...
            <DialogFooter>
              {newKey ? (
                <Button onClick={() => { setDialogOpen(false); setNewKey(""); setNewEmail(""); setNewProductId(""); setNewMaxActs("3"); setNewType("standard"); setNewTrialDays("14"); }}>Close</Button>
              ) : (
